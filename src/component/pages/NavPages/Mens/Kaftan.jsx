    ...
    <div className='md:px-5 font-serif'>
      <Link to={`/kafans-shirts/${product.id}`}>
        ...
        >
          ...
          <h3 className='text-sm font-semibold  text-white px-1 bg-red-400 rounded-xl w-19 text-center relative bottom-118 left-2 ml-3 md:ml-0'>ONSALE</h3>
    ...
    <div className='bg-black mt-23 z-10 pt-10'>
      <div className='space-y-7'>
        ...
        <div className='flex items-center justify-center gap-5'>
          <Link to={'/'} className='text-white'>Home</Link> <FaChevronRight className='text-white w-2' /> <span className='text-white'>Kaftan/shirts</span>
        </div>
      </div>
