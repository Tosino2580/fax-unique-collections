  ...
  return (
    <div className="bg-black text-white min-h-screen py-10 px-4 md:px-10 font-[Raleway]">
      <div className='flex items-center justify-center gap-2 md:gap-5 mt-23'>
          <Link to={'/'} className=' text-sm md:text-lg text-white'>Home</Link> <FaChevronRight className='text-white w-2' /> <span className='text-white text-sm md:text-lg'><Link to={'/agbada'}>Abgada</Link></span><FaChevronRight className='text-white w-2' /> <span className='text-sm md:text-lg'>{product.name}</span>
        </div>
